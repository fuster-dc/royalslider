...
$toemails[] = array(
	'email' => 'only1brucec@gmail.com', // Your Email Address
	'name' => 'Client Name' // Your Name
);
...
$fromemail = array(
	'email' => 'website@bdc-root.com', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'Website Contact Services' // Company Name
);
...
$recaptcha_secret = '6LdLbx4oAAAAAKaWe01c8p4RSPLiLtFq_6doiqra'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Company Name Website Contact Request';
	...
	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'Contact Request From Your Website';
	$mail->SetFrom( $fromemail['email'] , $fromemail['name'] );
    $mail->addBCC('clientmgmt@mymarketingmaniacs.com');
